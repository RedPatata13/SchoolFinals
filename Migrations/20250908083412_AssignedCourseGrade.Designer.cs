...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finals.Models.AssignedCourseGrade", b =>
                {
                    b.Property<string>("GradeId")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");

                    b.Property<string>("AssignedCourseId")
                        .IsRequired()
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("Finals.Models.AssignedCourseRegistration", b =>
                {
                    b.Property<string>("AssignedCourseRegistrationId")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");

                    b.Property<string>("AssignedCourseGradeId")
                        .HasColumnType("varchar(50)");
                    ...
                    b.HasKey("AssignedCourseRegistrationId");

                    b.HasIndex("AssignedCourseGradeId")
                        .IsUnique();
                    ...
                    b.ToTable("AssignedCourseRegistrations");
                });
            ...
            modelBuilder.Entity("Finals.Models.AssignedCourseGrade", b =>
                {
                    b.HasOne("Finals.Models.CourseModel_Assigned", "AssignedCourse")
                        .WithMany()
                        .HasForeignKey("AssignedCourseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Finals.Models.AssignedCourseRegistration", "Registration")
                        .WithOne()
                        .HasForeignKey("Finals.Models.AssignedCourseGrade", "RegistrationId");
            ...
            modelBuilder.Entity("Finals.Models.AssignedCourseRegistration", b =>
                {
                    b.HasOne("Finals.Models.AssignedCourseGrade", "AssignedCourseGrade")
                        .WithOne()
                        .HasForeignKey("Finals.Models.AssignedCourseRegistration", "AssignedCourseGradeId")
                        .OnDelete(DeleteBehavior.Restrict);
