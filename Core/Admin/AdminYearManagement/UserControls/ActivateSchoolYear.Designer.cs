...
{
    partial class ActivateSchoolYear
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label1.Name = "label1";
            label1.Size = new Size(843, 45);
            label1.TabIndex = 18;
            label1.Text = "Are you sure you wish to activate the drafted School Year?";
            // 
            // label6
            // 
            label6.AutoSize = true;
            label6.Font = new Font("Segoe UI", 12F);
            label6.Location = new Point(48, 150);
            label6.Name = "label6";
            ...
            label5.Location = new Point(40, 126);
            label5.Name = "label5";
            ...
            label4.Location = new Point(40, 82);
            label4.Name = "label4";
